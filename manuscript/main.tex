...
Standard categorical cross-entropy treats the three diagnostic tiers nominally, assigning equal loss regardless of whether a Severe OA case is misclassified as Moderate OA or Low/No OA. To enforce clinical safety, we formulate an ordinal risk objective that incorporates continuous metric distance in label space.
