...
\parbox{\columnwidth}{%
\footnotesize
\textit{Note:} Relative drop calculated with respect to the unablated full hybrid model baseline (83.44\% accuracy, 0.721 QWK) on the independent held-out test set under identical inference conditions.
}
...
\begin{tabular}{p{3.2cm}p{2.3cm}p{1.3cm}p{1.8cm}p{2cm}p{1.5cm}p{1.2cm}p{1.5cm}}
\toprule
...
\bibitem{liu2021swin}
Z.~Liu, Y.~Lin, Y.~Cao, H.~Hu, Y.~Wei, Y.~Zhang, B.~Dong, and B.~Guo, ``Swin Transformer: Hierarchical vision transformer using shifted windows,'' in \emph{Proceedings of the IEEE/CVF International Conference on Computer Vision (ICCV)}, 2021, pp. 10012--10022.
